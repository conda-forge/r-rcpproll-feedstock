...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-rcpproll-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rcpproll-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install r-rcpproll
```
...
It is possible to list all of the versions of `r-rcpproll` available on your platform:
...
```
pixi search r-rcpproll --channel conda-forge
```
